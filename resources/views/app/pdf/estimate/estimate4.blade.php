...
<div class="wrapper">
    ...
    <footer id="footer-text">
        ...
        @if($siret)
            <p style="display: block; width: 100%; color:#000; text-align: center; font-size:8px;"><span style="text-transform: capitalize">{{ $estimate->user->company->name }}</span> / Odran HUSSON est une société enregistrée avec le numéro de siret {{$siret}} <br>
        @endif
    </footer>
